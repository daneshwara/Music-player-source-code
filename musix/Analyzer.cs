...
namespace musix
{
    ...
    internal class Analyzer
    {
        ...
        public Analyzer(ProgressBar progressBar3, Spectrum spectrum2, Spectrum spectrum1, ComboBox comboBox1, Chart chart1)
        {
        }

        public Analyzer(ProgressBar progressBar3, ProgressBar progressBar2, Spectrum spectrum1, Spectrum spectrum2, ComboBox comboBox1, Chart chart1)
        {
